...
public class Tejo2Player : MonoBehaviour
{
    ...
    */
    ...
    public void OnTriggerEnter(Collider other)
    {
        ...
        if (evaluateHit)
        {
            ...
            if (!isChecking)
            {
                if (spawnManager.currentCancha == 1) { cameraManager.ZoomCancha1(); }
                else { cameraManager.ZoomCancha2(); }
